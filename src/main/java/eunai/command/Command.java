...
public class Command {
    ...
    private static String handleMark(String input, TaskList tasks) {
        try {
            ...
            task.markTask();
            return "Good job!! I am so proud of you and I've marked this task as done:\n" + task.getTaskString();
        } catch (Exception e) {
            return "Sorryz but could you please enter a valid task number after 'mark'.";
        }
    }
    ...
    private static String handleUnmark(String input, TaskList tasks) {
        try {
            ...
            task.unmarkTask();
            return "Oh gosh, you didn't actually finish it... I've marked this task as not done yet:\n"
                    + task.getTaskString();
        } catch (Exception e) {
    ...
    private static String extractFindKeyword(String input) throws EmptyTaskException {
        if (input.length() <= 5) {
            throw new EmptyTaskException("Oopsies! The keyword for find cannot be empty.");
        }
        return input.substring(5).trim();
    }
    ...
    private static String handleExit(TaskList tasks, Storage storage) {
        ...
        if (!isSaved) {
            return "Oopsies! I couldn't save your tasks. Something went wrong! Sorry manz.";
        }
        ...
        return "Byeee! I saved your tasks! Keep working on them, I'll see you next time!";
    }
    ...
    private static String getTaskAddedMessage(Task task, TaskList tasks) {
        return "Doneee! I've added this new task:\n" + task.getTaskString()
                + "\nNow you have " + tasks.getSize() + " tasks in the list.";
    }
}
